...
#Region "Form Load"
    ...
    Private Sub LoadTDBGrid(Optional ByVal FlagAdd As Boolean = False, Optional ByVal sKey As String = "")
        Dim sSQL As String = ""
        sSQL = "Select Distinct ReportCode, ReportName1" & UnicodeJoin(gbUnicode) & " as ReportName1, ReportID, Disabled, CreateUserID, CreateDate, LastModifyUserID, LastModifyDate From D02T3030  WITH (NOLOCK) Order By ReportCode"
    ...
    Private Sub Loadlanguage()
        '================================================================ 
        Me.Text = rl3("Danh_sach_bao_cao_chi_phi_xay_dung_co_ban_do_dang") & " - D02F5003" & UnicodeCaption(gbUnicode) 'Danh sÀch bÀo cÀo chi phÛ x¡y døng c¥ b¶n dê dang - D02F5003
        '================================================================ 
        ...
        ''Them ngay 20/2/2013 theo ID 54354 của Bảo Trân bởi Văn Vinh
...
#End Region
    ...
    Private Sub tsbDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles tsbDelete.Click, tsmDelete.Click, mnsDelete.Click
        ...
        Dim sSQL As String
        sSQL = "Delete D02T3030 Where ReportCode = " & SQLString(tdbg.Columns(COL_ReportCode).Text)
    ...
    Private Sub mnsExportDataSetup_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mnsExportDataScript.Click, tsmExportDataScript.Click
        ...
        SetProperties(arrPro, "sFormName", "D02F5003") ' Tài liệu phân tích
