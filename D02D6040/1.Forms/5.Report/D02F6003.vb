'#-------------------------------------------------------------------------------------
'# Created Date: 05/02/2009 10:27:39 AM
'# Created User: Thiên Huỳnh
'# Modify Date: 05/02/2009 10:27:39 AM
'# Modify User: Thiên Huỳnh
'#-------------------------------------------------------------------------------------
Public Class D02F6003
...
#Region "Form Load"
    ...
    Private Sub D02F6003_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
	LoadInfoGeneral()
        Loadlanguage()
    ...
    Private Sub LoadTDBGrid(Optional ByVal FlagAdd As Boolean = False, Optional ByVal sKey As String = "")
        Dim sSQL As String = ""
        sSQL = "Select Distinct ReportCode, ReportName1" & UnicodeJoin(gbUnicode) & " as ReportName1, ReportID, Disabled, CreateUserID, CreateDate, LastModifyUserID, LastModifyDate From D02T3040  WITH (NOLOCK) Order By ReportCode"
    ...
    Private Sub Loadlanguage()
        '================================================================ 
        Me.Text = rl3("Danh_sach_bao_cao_nghiep_vu_tac_dong") & " - D02F6003" & UnicodeCaption(gbUnicode) 'Danh sÀch bÀo cÀo nghiÖp vó tÀc ¢èng - D02F6003
        '================================================================ 
        ...
        ''Them ngay 20/2/2013 theo ID 54355 của Bảo Trân bởi Văn Vinh
...
#Region "C1Context Menu"
    ...
    Private Sub tsbDelete_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles tsbDelete.Click, tsmDelete.Click, mnsDelete.Click
        ...
        Dim sSQL As String
        sSQL = "Delete D02T3040 Where ReportCode = " & SQLString(tdbg.Columns(COL_ReportCode).Text)
...
#End Region
    ...
    Private Sub mnsExportDataSetup_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles mnsExportDataScript.Click, tsmExportDataScript.Click
        ...
        SetProperties(arrPro, "sFormName", "D02F6003") ' Tài liệu phân tích
